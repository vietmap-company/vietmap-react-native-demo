...
const MainScreen = ( props: { navigation: { navigate: (arg0: string) => void; }; } ) => {
...
const Greeting = () => {
    return (
        <Text style={styles.text}>
            This App contains some examples of what you can build with Vietmap React-Native SDK. The
            ...
            information about Vietmap, please refer to{' '}
            <Text
