...
const vietmapLogo:string = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFZA_JaP9I1vGrVjeCnUU_--zn0LpqVyeed6MvQMZ2rJz9s_5baAExPth7HbpS52hfi7I&usqp=CAU'
const AddMarker = () => {
    const [clickedCoordinate, setClickedCoordinate] = useState([106.900106, 10.74619])
